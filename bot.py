...
ENCOURAGEMENTS = {
    1: "💛 В этой игре нет приза, но хочется поблагодарить тебя за твое участие небольшими приятностями) *Время открыть пакетик с номером 1.* \nПусть эта зима будет теплой в душе 💕\n\n Вероятнее всего местоположение пакетиков уже было спалено, но если нет, то изучи шакафы)",
